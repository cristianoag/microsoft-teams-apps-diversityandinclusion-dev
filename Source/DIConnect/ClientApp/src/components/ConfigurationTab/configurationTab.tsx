...
import { Loader, List, Text, Flex, Checkbox, MoreIcon, MenuButton, Button, EditIcon, TrashCanIcon, Dialog, CloseIcon, AddIcon } from '@fluentui/react-northstar';
            ...
            return (
                <div>
                    <Flex className="title-container" gap="gap.small">
                        ...
                        <Flex.Item>
                            <Button content={this.localize("FaqSettingsText")} onClick={() => this.onFaqSettingButtonClick()} />
                        </Flex.Item>
                    </Flex>
